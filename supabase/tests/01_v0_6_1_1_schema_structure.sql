...
select is((
    ...
    from pg_tables
    where schemaname = 'public'
), 'match_correction_audit_entries,match_results,match_screenshot_metadata,matches,players,tournament_team_slots,tournaments'::text, 'no excluded public tables exist');
