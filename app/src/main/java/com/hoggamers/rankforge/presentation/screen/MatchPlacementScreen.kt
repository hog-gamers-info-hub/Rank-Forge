...
const val MATCH_PLACEMENT_RESET_ACTION_TEST_TAG = "match_placement_reset_action"
const val MATCH_PLACEMENT_RESET_CONFIRM_ACTION_TEST_TAG = "match_placement_reset_confirm_action"
        ...
        AlertDialog(
            ...
            confirmButton = {
                TextButton(
                    ...
                    modifier = Modifier.testTag(MATCH_PLACEMENT_RESET_CONFIRM_ACTION_TEST_TAG),
                ) {
