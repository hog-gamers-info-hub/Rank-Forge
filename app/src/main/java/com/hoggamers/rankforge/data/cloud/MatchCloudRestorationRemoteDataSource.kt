...
@Serializable data class MatchCloudRestorePayload(val id: String, @SerialName("tournament_id") val tournamentId: String, @SerialName("match_number") val matchNumber: Int, @SerialName("match_date") val matchDate: String, @SerialName("map_name") val mapName: String, val status: String)
...
@Singleton class SupabaseMatchCloudRestorationRemoteDataSource @Inject constructor(private val config: SupabaseAuthConfig, private val clientProvider: SupabaseClientProvider) : MatchCloudRestorationRemoteDataSource {
    override suspend fun readOwnedMatches(tournamentId: String): MatchCloudRestorationRemoteResult<MatchCloudRestorationPayloads> {
        ...
        return try {
            ...
            MatchCloudRestorationRemoteResult.Success(MatchCloudRestorationPayloads(tournamentId, matches, results))
